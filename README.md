...
- `R/bike_demand_regression_analysis.R` — complete R analysis, including data validation, exploratory analysis, regression modelling, diagnostics, LASSO cross-validation, and model evaluation.
- `outputs/figures/` — visualisations generated by the analysis.
- `outputs/tables/` — model results, coefficients, VIF diagnostics, and performance metrics.
- `outputs/session_info.txt` — R and package version information used for reproducibility.
